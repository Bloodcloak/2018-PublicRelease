...
AddOutputFilter chunkFilter
		...
		<Item Name="Auto Code" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Auto Movement" Type="Folder">
				<Item Name="AutoTurn.vi" Type="VI" URL="../AutoTurn.vi"/>
				<Item Name="AutoDrive.vi" Type="VI" URL="../AutoDrive.vi"/>
				<Item Name="AutoMove.vi" Type="VI" URL="../AutoMove.vi"/>
			</Item>
			<Item Name="Auto Movement v2" Type="Folder">
				<Item Name="Auto Move v2.vi" Type="VI" URL="../Auto Movement v2/Auto Move v2.vi"/>
				<Item Name="Auto Drive v2.vi" Type="VI" URL="../Auto Movement v2/Auto Drive v2.vi"/>
				<Item Name="Auto Turn v2.vi" Type="VI" URL="../Auto Movement v2/Auto Turn v2.vi"/>
				<Item Name="Auto Current-Amp Based Movement.vi" Type="VI" URL="../Auto Movement v2/Auto Current-Amp Based Movement.vi"/>
			</Item>
			<Item Name="Auto String Decoder.vi" Type="VI" URL="../Auto String Decoder.vi"/>
			<Item Name="Auto Command Parsing.vi" Type="VI" URL="../Auto Command Parsing.vi"/>
			<Item Name="Auto Command Executor.vi" Type="VI" URL="../Auto Command Executor.vi"/>
		</Item>
		<Item Name="Climb Code" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Climb Logic Core.vi" Type="VI" URL="../Climb Logic Core.vi"/>
			<Item Name="Climb Controls.ctl" Type="VI" URL="../Climb Controls.ctl"/>
			<Item Name="Climb Outputs.ctl" Type="VI" URL="../Climb Outputs.ctl"/>
		</Item>
		<Item Name="Cube Manipulation Logic" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Cube Manipulation Logic Core.vi" Type="VI" URL="../Cube Manipulation Logic Core.vi"/>
			<Item Name="Cube Manipulation Logic Core v2.vi" Type="VI" URL="../Cube Manipulation Logic Core v2.vi"/>
			<Item Name="Cube Logic Delayed Solinoid Status.vi" Type="VI" URL="../Cube Logic Delayed Solinoid Status.vi"/>
			<Item Name="Intake Wheels Logic.vi" Type="VI" URL="../Intake Wheels Logic.vi"/>
			<Item Name="Cube Manipulation Controls.ctl" Type="VI" URL="../Cube Manipulation Controls.ctl"/>
			<Item Name="Cube Manipulation Manual Controls.ctl" Type="VI" URL="../Cube Manipulation Manual Controls.ctl"/>
			<Item Name="Cube Manipulation Outputs.ctl" Type="VI" URL="../Cube Manipulation Outputs.ctl"/>
		</Item>
		<Item Name="Swerve Code" Type="Folder">
			<Item Name="Dependencies" Type="Folder">
				<Item Name="Convert Angle to Encoder v2.vi" Type="VI" URL="../Swerve Code/Convert Angle to Encoder v2.vi"/>
				<Item Name="Convert Encoder to Angle v2.vi" Type="VI" URL="../Swerve Code/Convert Encoder to Angle v2.vi"/>
				<Item Name="SwrvLinAlg Wheel Angles.vi" Type="VI" URL="../Swerve Code/SwrvLinAlg Wheel Angles.vi"/>
				<Item Name="SwrvLinAlg Wheel Core Debug Outputs.ctl" Type="VI" URL="../SwrvLinAlg Wheel Core Debug Outputs.ctl"/>
				<Item Name="SwrvLinAlg XY Relative to Robot.vi" Type="VI" URL="../Swerve Code/SwrvLinAlg XY Relative to Robot.vi"/>
			</Item>
			<Item Name="Swerve Begin.vi" Type="VI" URL="../Swerve Code/Swerve Begin.vi"/>
			<Item Name="Swerve Debug.vi" Type="VI" URL="../Swerve Code/Swerve Debug.vi"/>
			<Item Name="SwrvLinAlg Drive v2.vi" Type="VI" URL="../Swerve Code/SwrvLinAlg Drive v2.vi"/>
			<Item Name="SwrvLinAlg Full Spin Logic.vi" Type="VI" URL="../Swerve Code/SwrvLinAlg Full Spin Logic.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Source[0].itemID" Type="Str">{D3A82ACE-034C-4360-8B87-B9D938A47CAD}</Property>
